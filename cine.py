# cine.py
#Para que cine.py pueda gestionar 0 o negativos se debe añadir otro if dentro de
#vender_entradas para que lo gestione
class Pelicula:
    ...
    def vender_entradas(self, cantidad):
        if cantidad <= 0:
            return "Error: La cantidad de entradas debe ser mayor a cero."
